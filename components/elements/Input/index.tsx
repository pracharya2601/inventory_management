        ...
        <>
            ...
            >
                ...
                {props.onClear && (
                    <span
                        className={`${
                            props.square ? '' : 'rounded-lg cursor-pointer'
            ...
            {!props.error && props.withForceIndications && (
                <>
                    <div className="grid w-full h-1 grid-cols-12 gap-4 mt-3">
                        {[1, 2, 3, 4, 5, 6].map((indicatorLevel) => (
                            <div
                                ...
                                className={clsx('h-full col-span-2 rounded', {
                                    [`bg-${props.indicatorColor || 'green'}-500`]:
                                        indicatorLevel <= props.indicationLevel,
                    ...
                    {props.indicationLabel && (
                        <div
                            className={clsx('mt-2 text-xs mb-2', {
