...
const Icon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="">
  ...
  `;
    ...
    return (
        <div className="w-full lg:w-1/2 m-auto shadow bg-gray-100 dark:bg-gray-900 rounded p-2 flex flex-col items-center">
            <LiveProvider code={code} scope={{ Button }} theme={EDITOR_THEME}>
                <div className="w-full border-2 border-gray-500 rounded-t-xl">
                    <button onClick={() => copyCode()} className="bg-green-200 p-2 rounded m-2">
                    ...
                    <div className="px-1 py-2 flex flex-wrap items-center">
                        ...
                        <Button
                            ...
                            size="xs"
                            customClass="m-1"
                            label={`${icon ? 'Remove Icon' : 'Add Icon'}`}
                        />
                    </div>
                    <div className="px-1 py-2 flex flex-wrap items-center">
                    ...
                    <div className="px-1 py-2 flex flex-wrap items-center">
                        <span className="mr-1">Button Type:</span>
                    ...
                    <div className="px-1 py-2 flex flex-wrap items-center">
                        ...
                        <Button
                            ...
                            size="xs"
                            color={disable ? 'yellow' : 'red'}
                            customClass="m-1"
                            label={disable ? 'Remove Disable' : 'Disable'}
                        />
                    </div>
                    <div className="px-1 py-2 flex flex-wrap items-center">
                        <span className="mr-1">Disable:</span>
                        <Button
                            ...
                            size="xs"
                            customClass="m-1"
                            label={fullWidth ? 'Remove full width' : 'See full width'}
                        />
                    </div>
                    <div className="w-full">
                        <LiveEditor
                            className="rounded-b"
                            key={`${color}-${size}-${icon}-${variant}-${btnType}-${disable}-${fullWidth}`}
                        />
                    </div>
